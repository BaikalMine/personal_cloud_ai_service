...
param(
    ...
    [string]$KreaDiT = 'C:\Work\ComfyUI\models\diffusion_models\Krea2\krea2Raw_v10.safetensors',
...
$config = [ordered]@{
    ...
    profiles = @(
        [ordered]@{
            id = 'krea2-raw-official-bf16'
            family = 'krea2'
            name = 'Krea 2 Raw Official'
            base_model = 'krea2Raw_v10.safetensors'
            description = 'Рекомендуемая официальная RAW-база. Обучайте здесь, затем используйте LoRA в Krea 2 Turbo или Raw.'
            dit = $KreaDiT
            vae = $KreaVAE
