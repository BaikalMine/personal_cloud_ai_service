...
const aiGatewayReturnStyle = `<style id="ai-gateway-return-style">.ai-gateway-return-bar{position:relative;z-index:20;box-sizing:border-box;display:flex;align-items:center;justify-content:flex-end;width:100%;min-height:46px;padding:6px 14px;border-bottom:1px solid rgba(98,221,181,.28);background:rgba(23,23,23,.98);font-family:system-ui,sans-serif}.ai-gateway-return{display:inline-flex;align-items:center;gap:7px;padding:7px 11px;border:1px solid rgba(98,221,181,.72);border-radius:8px;background:#183c31;box-shadow:0 4px 14px rgba(0,0,0,.2);color:#b6f2dc;font:700 13px/1.2 system-ui,sans-serif;text-decoration:none;transition:background .16s ease,border-color .16s ease,transform .16s ease}.ai-gateway-return:hover{border-color:#83e7c6;background:#1b4335;transform:translateY(-1px)}.ai-gateway-return:focus-visible{outline:2px solid #55c7d8;outline-offset:2px}.ai-gateway-comfy-return-bar{position:fixed;top:10px;right:10px;z-index:99999;display:block;width:36px;height:36px;margin:0;padding:0;box-sizing:border-box;pointer-events:none}.ai-gateway-comfy-return-link{all:initial;box-sizing:border-box;display:flex;align-items:center;justify-content:center;width:36px;height:36px;padding:0;border:1px solid rgba(98,221,181,.72);border-radius:8px;background:#183c31;box-shadow:0 3px 10px rgba(0,0,0,.24);color:#b6f2dc;cursor:pointer;font:700 18px/1 system-ui,sans-serif;text-decoration:none;pointer-events:auto;transition:background .16s ease,border-color .16s ease,transform .16s ease}.ai-gateway-comfy-return-link:hover{border-color:#83e7c6;background:#1b4335;transform:translateY(-1px)}.ai-gateway-comfy-return-link:focus-visible{outline:2px solid #55c7d8;outline-offset:2px}@media (max-width:600px){.ai-gateway-comfy-return-bar{top:8px;right:8px}}</style>`

const openWebUIReturnLink = `<div class="ai-gateway-return-bar" role="navigation" aria-label="Навигация AI Gateway"><a class="ai-gateway-return" href="/app" aria-label="Вернуться в AI Gateway">&larr; AI Gateway</a></div>`
