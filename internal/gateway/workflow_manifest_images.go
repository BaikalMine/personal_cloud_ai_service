...
func krea2TextWorkflowManifest() workflowManifest {
	...
	return workflowManifest{
		ID: "photoflow-krea2", Version: "1", DefinitionID: "text-to-image-krea2", TemplateID: "text-to-image", Family: modelFamilyKrea2,
		Name: "PhotoFlow Krea2", Description: "Двухэтапная генерация Krea2 с апскейлом и финальной детализацией.", ModelFamilies: []string{modelFamilyKrea2},
		...
		Branches: []workflowBranchManifest{
			...
			{ID: "color_transfer", Name: "Перенос цвета", Description: "Финальное согласование цвета с первым проходом.", ToggleParameter: "color_transfer", RequiredClasses: []string{"ColorTransfer"}, Order: 30},
		},
		...
		Output:          workflowOutputManifest{Kinds: []string{"image"}, Postprocessing: []string{"upscale", "detail", "color_transfer"}},
	}
}
